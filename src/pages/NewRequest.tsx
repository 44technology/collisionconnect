...
import { Car, ArrowLeft, Upload, X, Camera, DollarSign, Info } from "lucide-react";
...
const NewRequest = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    toast.success("Your request has been submitted successfully! It's now under review.");
    navigate("/dashboard");
  };
